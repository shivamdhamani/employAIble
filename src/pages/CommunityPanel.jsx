...
const mentors = [
  {
    ...
    expertise: ['Excel via NVDA Screen Reader', 'Banking CBS Systems', 'Tally Prime Shortcuts', 'Keyboard Navigation'],
    mentees: 18, rating: 4.9, reviews: 29, sessions: 74,
    languages: ['Hindi', 'English'], badge: 'Senior Fellow', badgeColor: '#B45309',
    story: 'Certified by the National Institute for the Visually Handicapped (NIVH). Mastered NVDA & Tally keyboard workflows within 4 months. Employed at Ajmer Central Co-op Bank for 3+ years; conducts Saturday pro-bono typing clinics.',
    availability: 'Saturdays 10 am – 1 pm · Live Video & Screen Share',
    avatar: 'RK', avatarBg: '#0056B3',
    phone: '+91 94140 XXXXX',
  },
  {
    id: 2, name: 'Priya Meena', title: 'Senior Remote Customer Support Executive',
    org: 'TechSeva Solutions Pvt. Ltd.', location: 'Bhilwara, Rajasthan',
    disability: 'Locomotor Disability · 55% (Category C)', disabilityTag: 'Locomotor', disabilityColor: '#0056B3',
    expertise: ['WFH Ergonomics Setup', 'Freshdesk & Zoho CRM', 'GST Invoice Reconciliation', 'RPWD Act Self-Advocacy'],
    mentees: 14, rating: 4.9, reviews: 22, sessions: 51,
    languages: ['Hindi', 'Rajasthani'], badge: 'Rising Star', badgeColor: '#15803D',
    story: 'Wheelchair user who leveraged RPWD Act Section 20 reasonable accommodation mandates to secure a permanent work-from-home role. Has guided 14 locomotor candidates through MSME WFH contracts.',
    availability: 'Tue & Thu 6 – 8 pm · Accessible Text Chat',
    avatar: 'PM', avatarBg: '#0E7490',
    phone: '+91 96102 XXXXX',
  },
  {
    id: 3, name: 'Arvind Sharma', title: 'Data Archival & Digitisation Officer',
    org: 'Nagaur District Collectorate (Land Records)', location: 'Nagaur, Rajasthan',
    disability: 'Hearing & Speech Impairment · 80% (Category B)', disabilityTag: 'Hearing', disabilityColor: '#6D28D9',
    expertise: ['Government Recruitment Process', 'Kruti Dev / Mangal Typing (50+ WPM)', 'UDID Portal Fast-Track', 'E-NAM Data Verification'],
    mentees: 26, rating: 4.8, reviews: 38, sessions: 96,
    languages: ['Hindi', 'English', 'Indian Sign Language'], badge: 'Community Champion', badgeColor: '#0056B3',
    story: 'Trained at Ali Yavar Jung National Institute (AYJNISHD). Cleared Rajasthan Government Subordinate Services Selection Board typing exam with 99.2% accuracy. Expert on clearing UDID backlog and reservation rosters.',
    availability: 'Daily 7 – 9 am · Text & ISL Video',
    avatar: 'AS', avatarBg: '#6D28D9',
    phone: '+91 98291 XXXXX',
  },
  {
    id: 4, name: 'Sunita Patel', title: 'Senior Commercial Bookkeeper',
    ...
    expertise: ['Tally Prime 4.1', 'VAT to GST Transition', 'MSME Invoicing', 'Workplace Access Negotiation'],
    mentees: 11, rating: 4.9, reviews: 19, sessions: 39,
    languages: ['Hindi', 'Mewari'], badge: 'Verified Mentor', badgeColor: '#15803D',
    story: 'Overcame initial employer hesitation by presenting a functional accessibility blueprint from employAIble. Placed with an MSME 1.8 km from her home with ground-floor allocation. Manages ₹4 Cr annual trade ledger.',
    availability: 'Weekends 9 am – 12 pm · Video',
    avatar: 'SP', avatarBg: '#BE185D',
    phone: '+91 93510 XXXXX',
  },
  {
